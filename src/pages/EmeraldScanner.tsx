...
const EmeraldScanner = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const { error: uploadError } = await supabase.storage.from("scanner_uploads").upload(filePath, selectedFile, {
  ...
  return (
    <main
      className="bg-neutral-50 min-h-screen relative overflow-x-hidden font-sans"
    ...
    >
      ...
      <div className="pt-16 relative z-10">
        ...
        >
          {/* INTERFACCIA IPAD */}
          <div
            className="h-full w-full bg-neutral-50 relative flex flex-col overflow-y-auto"
          ...
          >
            ...
            {/* Content Area */}
            <div
              className="flex-1 relative w-full p-6 md:p-8 flex flex-col items-center justify-start overflow-y-auto"
              style={{ WebkitOverflowScrolling: "touch" }}
            >
                        ...
                        <div className="flex flex-col justify-center space-y-4 font-sans">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label
                                htmlFor="brand"
                                className="text-[10px] uppercase text-neutral-400 mb-1 block tracking-wider font-sans"
                              >
                                Brand
                              </Label>
                              <Input
                                ...
                                className="h-10 text-sm bg-neutral-50 border-transparent focus:bg-white rounded-lg font-sans"
                              />
                            </div>
                            <div>
                              <Label
                        ...
                        >
                          <div className="bg-white rounded-[2rem] p-10 md:p-14 border border-neutral-100 shadow-[0_8px_60px_-12px_rgba(0,0,0,0.06)]">
                            ...
                            <p className="font-serif text-lg md:text-xl text-stone-700 leading-relaxed italic max-w-sm mx-auto">
                              L'analisi di questo capo richiede un livello di dettaglio superiore. Ti invitiamo a
                              ricaricare l'immagine o a scansionare un nuovo articolo.
                            </p>
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-3">
                                <span className="text-[10px] uppercase tracking-wider text-stone-500 font-sans w-24 text-right shrink-0">
                                  Il tuo capo
                                </span>
                              ...
                              {/* Emeraldress bar */}
                              <div className="flex items-center gap-3">
                                <span className="text-[10px] uppercase tracking-wider text-emerald-700 font-sans w-24 text-right shrink-0">
                                  Emeraldress
                                </span>
                            ...
                            {score! < 50 && (
                              <p className="text-[10px] text-stone-500 font-sans mt-4 italic leading-relaxed tracking-wide">
                                Scegliere fibre riciclate certificate Emeraldress riduce l'impatto ambientale fino al
                                78% rispetto ai tessuti vergini, garantendo traspirabilità assoluta e rispetto per la
                                pelle.
                              </p>
                            )}
                          </motion.div>
      ...
      <section className="relative h-[60vh] w-full overflow-hidden flex items-center justify-center group">
        <div className="absolute inset-0 overflow-hidden">
          <img
            src="https://jtmbnmpggzbucmgglisw.supabase.co/storage/v1/object/public/emerald-asset/ASSET/emeraldress-emeraldscanner.webp"
