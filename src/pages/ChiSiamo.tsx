      ...
      >
        <div className="pt-16">
          ...
          <motion.div {...fadeUp} className="container mx-auto px-4 lg:px-8 max-w-2xl mb-20">
            <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground font-sans mb-2 text-center">
              La nostra storia
            </p>
            <h1 className="font-serif text-5xl mb-6 text-center md:text-7xl">Chi Siamo</h1>
